...
TESTAPP_XPS_TFT_PPC440_0_OUTPUT_DIR = TestApp_xps_tft_ppc440_0
TESTAPP_XPS_TFT_PPC440_0_OUTPUT = $(TESTAPP_XPS_TFT_PPC440_0_OUTPUT_DIR)/executable.elf

TESTAPP_XPS_TFT_COLORBAR_OUTPUT_DIR = TestApp_xps_tft_colorbar
TESTAPP_XPS_TFT_COLORBAR_OUTPUT = $(TESTAPP_XPS_TFT_COLORBAR_OUTPUT_DIR)/executable.elf

TESTAPP_XPS_TFT_COLORBAR_DDR_OUTPUT_DIR = TestApp_xps_tft_colorbar_ddr
TESTAPP_XPS_TFT_COLORBAR_DDR_OUTPUT = $(TESTAPP_XPS_TFT_COLORBAR_DDR_OUTPUT_DIR)/executable.elf
...
ALL_USER_ELF_FILES = $(TESTAPP_MEMORY_PPC440_0_OUTPUT) $(TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) $(TESTAPP_XPS_TFT_PPC440_0_OUTPUT) $(TESTAPP_XPS_TFT_COLORBAR_OUTPUT) $(TESTAPP_XPS_TFT_COLORBAR_DDR_OUTPUT) 
...
PROGRAMCLEAN_TARGETS = TestApp_Memory_ppc440_0_programclean TestApp_Peripheral_ppc440_0_programclean TestApp_xps_tft_ppc440_0_programclean TestApp_xps_tft_colorbar_programclean TestApp_xps_tft_colorbar_ddr_programclean 
...
#################################################################
# SOFTWARE APPLICATION TESTAPP_XPS_TFT_PPC440_0
#################################################################

TESTAPP_XPS_TFT_PPC440_0_SOURCES = TestApp_xps_tft_ppc440_0/src/xtft_example.c 

TESTAPP_XPS_TFT_PPC440_0_HEADERS = 

TESTAPP_XPS_TFT_PPC440_0_CC = powerpc-eabi-gcc
TESTAPP_XPS_TFT_PPC440_0_CC_SIZE = powerpc-eabi-size
TESTAPP_XPS_TFT_PPC440_0_CC_OPT = -O2
TESTAPP_XPS_TFT_PPC440_0_CFLAGS = 
TESTAPP_XPS_TFT_PPC440_0_CC_SEARCH = # -B
TESTAPP_XPS_TFT_PPC440_0_LIBPATH = -L./ppc440_0/lib/ # -L
TESTAPP_XPS_TFT_PPC440_0_INCLUDES = -I./ppc440_0/include/ # -I
TESTAPP_XPS_TFT_PPC440_0_LFLAGS = # -l
TESTAPP_XPS_TFT_PPC440_0_LINKER_SCRIPT = TestApp_xps_tft_ppc440_0/src/TestApp_xps_tft_LinkSrc.ld
TESTAPP_XPS_TFT_PPC440_0_LINKER_SCRIPT_FLAG = -Wl,-T -Wl,$(TESTAPP_XPS_TFT_PPC440_0_LINKER_SCRIPT) 
TESTAPP_XPS_TFT_PPC440_0_CC_DEBUG_FLAG =  -g 
TESTAPP_XPS_TFT_PPC440_0_CC_PROFILE_FLAG = # -pg
TESTAPP_XPS_TFT_PPC440_0_CC_GLOBPTR_FLAG= # -msdata=eabi
TESTAPP_XPS_TFT_PPC440_0_CC_INFERRED_FLAGS= -mcpu=440 
TESTAPP_XPS_TFT_PPC440_0_CC_START_ADDR_FLAG=  #  # -Wl,-defsym -Wl,_START_ADDR=
TESTAPP_XPS_TFT_PPC440_0_CC_STACK_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_STACK_SIZE=
TESTAPP_XPS_TFT_PPC440_0_CC_HEAP_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_HEAP_SIZE=
TESTAPP_XPS_TFT_PPC440_0_OTHER_CC_FLAGS= $(TESTAPP_XPS_TFT_PPC440_0_CC_GLOBPTR_FLAG)  \
                  $(TESTAPP_XPS_TFT_PPC440_0_CC_START_ADDR_FLAG) $(TESTAPP_XPS_TFT_PPC440_0_CC_STACK_SIZE_FLAG) $(TESTAPP_XPS_TFT_PPC440_0_CC_HEAP_SIZE_FLAG)  \
                  $(TESTAPP_XPS_TFT_PPC440_0_CC_INFERRED_FLAGS)  \
                  $(TESTAPP_XPS_TFT_PPC440_0_LINKER_SCRIPT_FLAG) $(TESTAPP_XPS_TFT_PPC440_0_CC_DEBUG_FLAG) $(TESTAPP_XPS_TFT_PPC440_0_CC_PROFILE_FLAG) 

#################################################################
# SOFTWARE APPLICATION TESTAPP_XPS_TFT_COLORBAR
#################################################################

TESTAPP_XPS_TFT_COLORBAR_SOURCES = TestApp_xps_tft_colorbar/src/xtft_tapp_colorbar.c 

TESTAPP_XPS_TFT_COLORBAR_HEADERS = 

TESTAPP_XPS_TFT_COLORBAR_CC = powerpc-eabi-gcc
TESTAPP_XPS_TFT_COLORBAR_CC_SIZE = powerpc-eabi-size
TESTAPP_XPS_TFT_COLORBAR_CC_OPT = -O2
TESTAPP_XPS_TFT_COLORBAR_CFLAGS = 
TESTAPP_XPS_TFT_COLORBAR_CC_SEARCH = # -B
TESTAPP_XPS_TFT_COLORBAR_LIBPATH = -L./ppc440_0/lib/ # -L
TESTAPP_XPS_TFT_COLORBAR_INCLUDES = -I./ppc440_0/include/ # -I
TESTAPP_XPS_TFT_COLORBAR_LFLAGS = # -l
TESTAPP_XPS_TFT_COLORBAR_LINKER_SCRIPT = TestApp_xps_tft_colorbar/src/xtft_tapp_LinkSrc.ld
TESTAPP_XPS_TFT_COLORBAR_LINKER_SCRIPT_FLAG = -Wl,-T -Wl,$(TESTAPP_XPS_TFT_COLORBAR_LINKER_SCRIPT) 
TESTAPP_XPS_TFT_COLORBAR_CC_DEBUG_FLAG =  -g 
TESTAPP_XPS_TFT_COLORBAR_CC_PROFILE_FLAG = # -pg
TESTAPP_XPS_TFT_COLORBAR_CC_GLOBPTR_FLAG= # -msdata=eabi
TESTAPP_XPS_TFT_COLORBAR_CC_INFERRED_FLAGS= -mcpu=440 
TESTAPP_XPS_TFT_COLORBAR_CC_START_ADDR_FLAG=  #  # -Wl,-defsym -Wl,_START_ADDR=
TESTAPP_XPS_TFT_COLORBAR_CC_STACK_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_STACK_SIZE=
TESTAPP_XPS_TFT_COLORBAR_CC_HEAP_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_HEAP_SIZE=
TESTAPP_XPS_TFT_COLORBAR_OTHER_CC_FLAGS= $(TESTAPP_XPS_TFT_COLORBAR_CC_GLOBPTR_FLAG)  \
                  $(TESTAPP_XPS_TFT_COLORBAR_CC_START_ADDR_FLAG) $(TESTAPP_XPS_TFT_COLORBAR_CC_STACK_SIZE_FLAG) $(TESTAPP_XPS_TFT_COLORBAR_CC_HEAP_SIZE_FLAG)  \
                  $(TESTAPP_XPS_TFT_COLORBAR_CC_INFERRED_FLAGS)  \
                  $(TESTAPP_XPS_TFT_COLORBAR_LINKER_SCRIPT_FLAG) $(TESTAPP_XPS_TFT_COLORBAR_CC_DEBUG_FLAG) $(TESTAPP_XPS_TFT_COLORBAR_CC_PROFILE_FLAG) 

#################################################################
# SOFTWARE APPLICATION TESTAPP_XPS_TFT_COLORBAR_DDR
#################################################################

TESTAPP_XPS_TFT_COLORBAR_DDR_SOURCES = TestApp_xps_tft_colorbar_ddr/src/colorbar.c 

TESTAPP_XPS_TFT_COLORBAR_DDR_HEADERS = 

TESTAPP_XPS_TFT_COLORBAR_DDR_CC = powerpc-eabi-gcc
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_SIZE = powerpc-eabi-size
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_OPT = -O2
TESTAPP_XPS_TFT_COLORBAR_DDR_CFLAGS = 
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_SEARCH = # -B
TESTAPP_XPS_TFT_COLORBAR_DDR_LIBPATH = -L./ppc440_0/lib/ # -L
TESTAPP_XPS_TFT_COLORBAR_DDR_INCLUDES = -I./ppc440_0/include/ # -I
TESTAPP_XPS_TFT_COLORBAR_DDR_LFLAGS = # -l
TESTAPP_XPS_TFT_COLORBAR_DDR_LINKER_SCRIPT = 
TESTAPP_XPS_TFT_COLORBAR_DDR_LINKER_SCRIPT_FLAG = #-Wl,-T -Wl,$(TESTAPP_XPS_TFT_COLORBAR_DDR_LINKER_SCRIPT) 
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_DEBUG_FLAG =  -g 
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_PROFILE_FLAG = # -pg
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_GLOBPTR_FLAG= # -msdata=eabi
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_INFERRED_FLAGS= -mcpu=440 
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_START_ADDR_FLAG=  # -Wl,-defsym -Wl,_START_ADDR=
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_STACK_SIZE_FLAG=  # -Wl,-defsym -Wl,_STACK_SIZE=
TESTAPP_XPS_TFT_COLORBAR_DDR_CC_HEAP_SIZE_FLAG=  # -Wl,-defsym -Wl,_HEAP_SIZE=
TESTAPP_XPS_TFT_COLORBAR_DDR_OTHER_CC_FLAGS= $(TESTAPP_XPS_TFT_COLORBAR_DDR_CC_GLOBPTR_FLAG)  \
                  $(TESTAPP_XPS_TFT_COLORBAR_DDR_CC_START_ADDR_FLAG) $(TESTAPP_XPS_TFT_COLORBAR_DDR_CC_STACK_SIZE_FLAG) $(TESTAPP_XPS_TFT_COLORBAR_DDR_CC_HEAP_SIZE_FLAG)  \
                  $(TESTAPP_XPS_TFT_COLORBAR_DDR_CC_INFERRED_FLAGS)  \
                  $(TESTAPP_XPS_TFT_COLORBAR_DDR_LINKER_SCRIPT_FLAG) $(TESTAPP_XPS_TFT_COLORBAR_DDR_CC_DEBUG_FLAG) $(TESTAPP_XPS_TFT_COLORBAR_DDR_CC_PROFILE_FLAG) 
